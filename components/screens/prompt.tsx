  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-xs uppercase tracking-wider text-[var(--ink-4)]">Reported {timeLabel}</p>
        ...
        <div className="grid grid-cols-3 gap-2 mt-5">
          <button onClick={() => submit(false)}
            className="py-3 rounded-xl bg-[var(--paper-2)] text-[var(--ink)] active:scale-[0.98] transition-transform">No</button>
          <button onClick={() => submit(null)}
            className="py-3 rounded-xl bg-transparent text-[var(--ink-3)] active:scale-[0.98] transition-transform">Skip</button>
          <button onClick={() => submit(true)}
            className="py-3 rounded-xl bg-[var(--sev-acute)] text-white active:scale-[0.98] transition-transform">Yes</button>
        </div>
      </div>
    </div>
  );
